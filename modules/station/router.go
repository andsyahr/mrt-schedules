...
import (
	...
	"github.com/andsyahr/mrt-schedules/common/response"
...
func CheckSchedulesByStation(c *gin.Context, serservice Service) {
	id := c.Param("id")

	datas, err := serservice.CheckSchedulesByStation(id)
